...
import DisplayAssociates from './DisplayAssociates';
...
describe("Search unit test", () => {
    ...
    beforeEach(() => {
        ...
        /* shallow rendering */
        wrapper = shallow(<DisplayAssociates store={store} />);
    });

    describe("on mount", () => {

      	it('Rendering component without props.', () => {
    		const component = shallow(<DisplayAssociates/>);
    		expect(component).toMatchSnapshot();
      	});

      	it('Rendering component with children.', () => {
    		const component = render(<DisplayAssociates/>);
    		expect(component).toMatchSnapshot();
      	});

      	it('Mounting, testing list item mapping, and dismounting the component.', () => {
    		const component = mount(<DisplayAssociates/>);
    		expect(component).toMatchSnapshot();
    		component.unmount();
      	});
